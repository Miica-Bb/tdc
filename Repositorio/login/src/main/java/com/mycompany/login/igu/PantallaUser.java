...
public class PantallaUser extends javax.swing.JFrame {
    ...
    public PantallaUser(ControladoraLogica controlL, Usuario usr) {
        initComponents();
    ...
    private void cargarTabla() {
        ...
        String titulos[] = {"id", "nombre_usuario", "rol"};
        modeloTabla.setColumnIdentifiers(titulos);
        
        List<Usuario> listaUsuarios = controlL.buscarListaUsuarios();
        if(listaUsuarios != null) {
            for (Usuario unUser : listaUsuarios) {
                Object[] atributo = {unUser.getId(), unUser.getNombreUsuario(), unUser.getUnRol().getNombreRol()};
